        ...
        <div className="h-16 flex items-center justify-between">
          ...
          >
            <div className="relative">
              <div className="h-10 w-10 rounded-xl bg-linear-to-br from-primary to-primary/80 flex items-center justify-center shadow-lg shadow-primary/25 group-hover:shadow-primary/40 transition-smooth group-hover:scale-105">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <a
                  ...
                  className="p-2.5 rounded-lg text-muted-foreground hover:text-foreground hover:bg-accent transition-smooth"
